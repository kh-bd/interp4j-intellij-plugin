 ...
 */
public class SInterpolationLanguageInjector extends AbstractInterpolationLanguageInjector {

    SInterpolationLanguageInjector() {
        super(Interp4jPsiUtil::isSMethodCall);
    }
